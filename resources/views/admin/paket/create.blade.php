          ...
          <div class="max-w-4xl">
            <div class="flex items-start justify-between gap-4 mb-6">
              <div>
                ...
                <p class="text-sm text-gray-600">Buat paket baru (Bimbingan Haji atau Umroh).</p>
              </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6">
              <form method="POST" action="{{ route('admin.paket.store') }}" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  <div class="sm:col-span-2">
                    ...
                    <input
                      ...
                      placeholder="Contoh: Bimbingan Haji Reguler"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="BIMBINGAN_HAJI" {{ old('type') === 'BIMBINGAN_HAJI' ? 'selected' : '' }}>Bimbingan Haji</option>
                    ...
                    <div class="mt-1">
                      <div class="flex items-center justify-between gap-3">
                        ...
                        <button
                          type="button"
                          id="addFasilitasBtn"
                          class="inline-flex items-center rounded-md border border-gray-300 bg-green-600 px-4 py-1.5 text-sm font-medium text-white hover:bg-green-700"
                        >
                          +
                        </button>
                      </div>
                        ...
                        @foreach ($fasilitasValues as $index => $item)
                          <div class="flex items-center gap-2 fasilitas-row">
                            ...
                            <button
                              ...
                              class="inline-flex items-center rounded-md bg-red-600 px-3 py-2 text-sm font-medium  hover:bg-red-700 text-white"
...
(function () {
    ...
    function addRow(value) {
        ...
        removeBtn.className =
            "inline-flex items-center rounded-md bg-red-600 px-3 py-2 text-sm font-medium  hover:bg-red-700 text-white";
