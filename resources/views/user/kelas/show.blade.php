    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6 flex items-start justify-between gap-4">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Kelas untuk Order #{{ $order->id ?? '' }}</h3>
                    <p class="text-sm text-gray-600">Lihat detail kelas dan jadwal manasik.</p>
                </div>
                <a
                    href="{{ url()->previous() }}"
                ...
                <div class="lg:col-span-2">
                    <div class="rounded-lg border border-gray-200 bg-white overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-200">
                            ...
                            <p class="text-sm text-gray-600">Jadwal manasik untuk kelas kamu.</p>
                        </div>

                        @if (!$kelas)
                            <div class="p-6 text-sm text-gray-600">Belum ada sesi karena kelas belum ditentukan.</div>
