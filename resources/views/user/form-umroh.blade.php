  ...
  <body class="font-sans antialiased bg-gray-100">
    ...
    <main class="max-w-[90%] md:max-w-3xl lg:max-w-6xl mx-auto py-8">
      <div class="bg-white border border-gray-200 rounded-lg p-6">
        <h2 class="text-xl font-semibold text-green-900">Form Pendaftaran Paket Umroh</h2>
        <p class="text-sm text-gray-600 mt-1">
          Lengkapi data jamaah, tanggal keberangkatan (opsional), dan upload dokumen untuk diproses admin.
        </p>
        ...
        <form
          class="mt-6"
          method="POST"
          action="{{ route('umroh.store', $paket) }}"
        ...
        >
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
              <h3 class="font-semibold">Keberangkatan</h3>
              <div class="mt-3">
                <label class="block text-sm font-medium" for="tanggal_keberangkatan">Tanggal Keberangkatan (opsional)</label>
                <input
